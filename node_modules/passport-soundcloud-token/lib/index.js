...
var SoundCloudTokenStrategy = function (_OAuth2Strategy) {
  ...
  function SoundCloudTokenStrategy(_options, _verify) {
    ...
    var _this = _possibleConstructorReturn(this, (SoundCloudTokenStrategy.__proto__ || Object.getPrototypeOf(SoundCloudTokenStrategy)).call(this, options, verify));
    ...
    _this._oauth2.setAccessTokenName(options.oauth2AccessTokenName || 'oauth_token');
    return _this;
  }
